...
from usefulfeatures import get_values_remove_and_clear as GETandREMOVEandCLEAR
...
class RemoveWindow(TK.Toplevel):
    ...
    # ID
        ...
        self.entry_id = TTK.Entry(self,textvariable=self.id_field_content)
        ...
        btn_remove = TK.Button(self, text="Удалить",
